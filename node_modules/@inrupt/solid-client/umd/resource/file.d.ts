 ...
 */
export declare function getFile(fileUrl: Url | UrlString, options?: Partial<GetFileOptions>): Promise<File & WithServerResourceInfo>;
/**
 ...
 */
export declare function saveFileInContainer<FileExt extends File>(folderUrl: Url | UrlString, file: FileExt, options?: Partial<SaveFileOptions>): Promise<FileExt & WithResourceInfo>;
/**
 ...
 */
export declare function overwriteFile<FileExt extends File>(fileUrl: Url | UrlString, file: FileExt, options?: Partial<WriteFileOptions>): Promise<FileExt & WithResourceInfo>;
/**
